...
const StripeDemo = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch("http://localhost:3002/stripe/create-checkout-session", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization:
            "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY0OGMyODAyNjgwM2ViMDBmOWYwNTdiMSIsImlhdCI6MTY4NzIzOTk2NSwiZXhwIjoxNjg3MzI2MzY1fQ.-MUyslNHGEEiRrP0cyfePXkBmszZsOnuDUcJpv6rcg4",
        },
